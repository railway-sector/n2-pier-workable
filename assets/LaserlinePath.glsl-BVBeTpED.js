import{kb as be,my as we,pQ as De,EK as f,pH as w,pN as Ve,px as H,Iw as r,sm as j,Gp as ee,BN as xe,pE as L,lp as te,iy as A,jf as B,pR as Ee,C9 as ie,EQ as ne,pC as S,gp as _,AJ as v,Nw as se,z_ as ae,yR as o,JE as re,hg as ye,F as Le,fe as Se,ot as le,z2 as oe,KP as Ce,IC as Me,uh as Ae,Iz as $e,pI as Re,Ah as F,op as Te,nw as ce,HX as he,iY as de,ly as Oe,DE as G,KW as z,iV as c,lf as q,Hv as pe,fG as ue,os as Ie,Ji as I,iE as Ue,EN as ze,DW as je,kc as qe,uE as V,JL as Ne,gV as k,GQ as We,DZ as He,C_ as $,BP as Be,b0 as J,y4 as Fe,L2 as Ge,eY as ke,Cs as Je,kO as Qe,u2 as Ke,j1 as C,l1 as Xe,Hb as Q}from"./index-Dmp8x7bg.js";import{t as Ye}from"./VisualElement-Cfsy6H6z.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
