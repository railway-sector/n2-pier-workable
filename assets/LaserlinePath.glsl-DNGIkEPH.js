import{jH as be,l_ as we,p4 as De,DL as f,oX as w,p1 as Ve,oN as W,Hn as r,rt as j,Fk as ee,AT as xe,oU as E,kS as te,i0 as A,iL as B,p5 as Le,Bg as ie,DR as ne,oS as S,f$ as _,zP as v,Mn as se,z2 as ae,xX as o,Iu as re,gM as ye,F as Ee,e$ as Se,nJ as le,y7 as oe,JF as Ce,Ht as Me,tp as Ae,Hq as $e,oY as Re,zl as H,nF as Te,mN as ce,GO as he,is as de,k$ as Oe,CF as G,JM as z,ip as c,kI as q,Gm as pe,fk as ue,nI as Ie,I8 as I,i6 as Ue,DO as ze,CX as je,jI as qe,tN as V,IB as Ne,gs as k,FL as Fe,C_ as We,C5 as $,AV as Be,aW as J,x9 as He,JU as Ge,eJ as ke,Bz as Je,kf as Xe,ta as Qe,ix as C,ku as Ye,G2 as X}from"./index-aV5kfHV2.js";import{t as Ze}from"./VisualElement-C5FWTZWY.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
