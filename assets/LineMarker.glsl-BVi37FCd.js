import{Gp as te,r9 as ie,uH as re,r5 as ae,pI as se,pJ as oe,Iw as o,CZ as ne,Iz as ce,EQ as le,Ah as y,LX as pe,pK as de,GM as R,t6 as he,Kp as ve,pw as ue,pE as me,px as fe,uI as I,o2 as U,Ak as ge,k8 as Se,n_ as Pe,fG as ye,nw as we,Hv as _e,HX as xe,iY as ze,eW as D,Nv as B,mv as $e,EL as G,rK as M,r6 as be,xk as ke,GL as Ve,Al as Oe,uJ as q,k9 as H,ra as Te,pL as Ce,GN as We,iV as d,lf as De,IA as Le,uE as m,Fx as Me,CX as L,rX as je,o3 as X,Bk as Ae,pG as Fe,IB as Ne,pz as Ee,Ji as J,bM as Re,gp as K,yR as Y,eg as Ie}from"./index-Dmp8x7bg.js";function Q(r){const e=new te,{space:a,anchor:t,hasTip:w,hasScreenSizePerspective:x}=r,f=a===2,k=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:S,varyings:g}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),g.add("vColor","vec4"),g.add("vpos","vec3",{invariant:!0}),g.add("vUV","vec2"),g.add("vSize","float"),w&&g.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
