...
// Monopiles
const monopileRenderer = new SimpleRenderer({
...
const monopileLabel = new LabelClass({
  symbol: new TextSymbol({
    color: "black",
    font: {
      size: 10,
  ...
  labelPlacement: "above-right",
  labelExpressionInfo: {
    expression: '$feature.PierNumber + " (Monopile)"',
  },
});
...
export const monopilesLayer = new FeatureLayer({
  ...
  renderer: monopileRenderer,
  labelingInfo: [monopileLabel],
});
